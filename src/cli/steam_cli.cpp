...
void print_cli_usage() {
    std::cout << "CAuth\n"
              ...
              << "  cauth --version\n"
              << "  cauth doctor\n"
              << "  cauth steam auth login --username <name> --password-stdin [--guard-code <code>] [--poll-attempts <count>] [--device-name <caller name>] [--cm-max-count <count>] [--route-endpoint <host:port>] [--route-protocol websocket]  (Ctrl+C cancels polling)\n"
              << "  cauth steam auth login-web --username <name> --password-stdin [--guard-code <code>] [--poll-attempts <count>] [--device-name <caller name>]  (Ctrl+C cancels polling)\n"
              << "  cauth steam auth login-mobile --username <name> --password-stdin [--guard-code <code>] [--poll-attempts <count>] [--device-name <caller name>]  (Ctrl+C cancels polling)\n"
