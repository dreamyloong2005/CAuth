...
void print_cli_usage() {
    std::cout << "CAuth\n"
              ...
              << "  cauth steam auth cm logon --steam-id <id> [--max-count <count>]\n"
              << "  cauth steam auth cm app-info --steam-id <id> --app-id <id> [--max-count <count>]\n"
              << "  cauth steam auth cm frame-test\n"
              << "  cauth steam depot branches --steam-id <id> --app-id <id> [--max-count <count>]\n"
              << "  cauth steam depot manifests --steam-id <id> --app-id <id> --branch <name> [--max-count <count>]\n"
              << "  cauth steam depot key --steam-id <id> --app-id <id> --depot-id <id> [--max-count <count>]\n"
              << "  cauth steam depot preflight --steam-id <id> --app-id <id> --branch <name> [--max-count <count>]\n"
              << "  cauth steam depot manifest-code --steam-id <id> --app-id <id> --depot-id <id> --manifest-gid <gid> [--branch <name>] [--max-count <count>]\n"
              << "  cauth steam depot manifest-download --depot-id <id> --manifest-gid <gid> --request-code <code> --out <path> [--max-count <count>] [--overwrite|--skip-existing|--fail-if-exists] [--no-atomic-write]\n"
              ...
              << "  cauth steam depot chunk-download --in <manifest> (--file-index <index>|--file <path>) --chunk-index <index> --out <path> [--depot-key <hex>] [--process] [--max-count <count>] [--overwrite|--skip-existing|--fail-if-exists] [--no-atomic-write]\n"
              << "  cauth steam depot file-download --in <manifest> (--file-index <index>|--file <path>) --depot-key <hex> --out <path> [--max-count <count>] [--overwrite|--skip-existing|--fail-if-exists] [--no-atomic-write]\n"
              << "  cauth steam depot all-files-download --in <manifest> --depot-key <hex> --out-dir <path> [--max-count <count>] [--overwrite|--skip-existing|--fail-if-exists] [--no-atomic-write]\n"
              << "  cauth steam cloud list --steam-id <id> --app-id <id> [--access-token <token>] [--remote-root <path>] [--count <count>] [--start-index <index>] [--extended-details 0|1]\n"
              << "  cauth steam cloud verify --steam-id <id> --app-id <id> --local-root <path> [--access-token <token>] [--remote-root <path>] [--include-extra-local] [--extended-details 0|1]\n"
              << "  cauth steam cloud pull --steam-id <id> --app-id <id> --local-root <path> [--access-token <token>] [--remote-root <path>] [--dry-run] [--conflict-policy default|local-wins|remote-wins|newer-wins|fail] [--overwrite|--skip-existing|--fail-if-exists] [--no-atomic-write]\n"
              << "  cauth steam cloud push --steam-id <id> --app-id <id> --local-root <path> [--access-token <token>] [--remote-root <path>] [--dry-run] [--delete-remote-orphans] [--conflict-policy default|local-wins|remote-wins|newer-wins|fail]\n";
}
