...
void print_cli_usage() {
    std::cout << "CAuth\n"
              ...
              << "  cauth steam cloud pull --steam-id <id> --app-id <id> --local-root <path> [--access-token <token>] [--remote-root <path>] [--dry-run] [--conflict-policy default|local-wins|remote-wins|newer-wins|fail]\n"
